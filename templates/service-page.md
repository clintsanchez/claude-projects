...
Single markdown document, all sections labeled with H2s, ready to hand to a designer or paste into the CMS. Add an `[IMAGE: ...]` placeholder where a screenshot, logo line, or testimonial avatar should sit.
